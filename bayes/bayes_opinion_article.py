            ...
            if row[1] == "1":
                ...
                for single_date in daterange(start_date, end_date):
                    ...
                    if os.path.isfile('../../../../tmp2/finance_data/filtered_opinion/'+ str(single_date.strftime("%Y%m%d")) + ".npy"):
                        ...
                        with open('../../../../tmp2/finance_data/filtered_opinion/'  + str(
...
def testingNB():
    ...
    ff = open('result_opinion_article.csv', 'w')
    ff.write("date,rate\n")
        ...
        for row in reader:
            ...
            for single_date in daterange(start_date, end_date):
                ...
                if os.path.isfile('../../../../tmp2/finance_data/filtered_opinion/'+ str(single_date.strftime("%Y%m%d")) + ".npy"):
                    ...
                    with open('../../../../tmp2/finance_data/filtered_opinion/' + str(single_date.strftime("%Y%m%d")) + ".npy",
                            'r') as myfile:

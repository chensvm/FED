...
adam = optimizers.Adam(lr=0.0005, beta_1=0.9, beta_2=0.999, epsilon=1e-08, decay=0.0) #optimizers.Adam(lr=0.001, beta_1=0.9, beta_2=0.999, epsilon=1e-08, decay=0.0)
...
plt.show()
plt.savefig('acc_54_regulizer.png') ;
plt.clf()
...
plt.legend(['train', 'test'], loc='upper left')#plt.legend(['train', 'test'], loc='upper left')
plt.show()
plt.savefig('loss_54_regulizer.png') ;
